    ...
    <div className="space-y-6 select-none">
      <div className="bg-white border border-slate-200 rounded-3xl p-6 relative overflow-hidden shadow-sm">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-base font-bold text-govnavy uppercase tracking-wide">Public Safety Incident Map</h2>
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-0.5">District density maps for public safety assessment</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-105 p-4 rounded-2xl flex items-start gap-2.5 text-[10px] text-blue-750 font-bold leading-normal">
        ...
        <p>This map compiles public safety zones based on consolidated regional crime volumes. Critical node locations are filtered to ensure tactical operations parameters remain confidential.</p>
      </div>
    </div>
  )
}
